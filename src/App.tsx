  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <header className="border-b border-[#eee] bg-white sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-5 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="rounded-md bg-[#e95f3d] p-1.5">
              <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <div>
              <h1 className="text-base font-bold text-[#333]">ImageShrink</h1>
              <p className="text-[11px] text-[#999]">บีบอัดภาพให้เล็กลง คุณภาพเท่าเดิม</p>
            </div>
          </div>
          {doneCount > 0 && (
            <button
              onClick={downloadAll}
              className="rounded-md bg-[#e95f3d] px-4 py-2 text-sm font-medium text-white hover:bg-[#d14e2f] transition-colors flex items-center gap-1.5"
            >
      ...
      <main className="max-w-5xl mx-auto px-5 py-8">
        ...
        {images.length === 0 && (
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="rounded-lg bg-white border border-[#eee] p-5 text-center">
              <div className="rounded-md bg-[#fef2ee] w-11 h-11 flex items-center justify-center mx-auto mb-3">
                <svg className="w-5 h-5 text-[#e95f3d]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
              <h3 className="font-semibold text-[#333] text-sm mb-1.5">ปลอดภัย 100%</h3>
            ...
            <div className="rounded-lg bg-white border border-[#eee] p-5 text-center">
              ...
              <h3 className="font-semibold text-[#333] text-sm mb-1.5">รวดเร็ว</h3>
              <p className="text-xs text-[#888] leading-relaxed">
            ...
            <div className="rounded-lg bg-white border border-[#eee] p-5 text-center">
              ...
              <h3 className="font-semibold text-[#333] text-sm mb-1.5">คุณภาพสูง</h3>
              <p className="text-xs text-[#888] leading-relaxed">
      ...
      <footer className="border-t border-[#eee] mt-16">
        <div className="max-w-5xl mx-auto px-5 py-5 text-center text-xs text-[#aaa]">
